...
figuresets73.py
================
The drop_motifs7.3 figure set. Same wiring as `figuresets72` - the span
signal is threaded through because the millivolt-per-second comes from the
span panel's own geometry - pointed at the 7.3 drawing modules.
"""

import json

from Pipelines.drop_motifs.clusterfigs73 import plot_dendrogram_page, plot_rose
