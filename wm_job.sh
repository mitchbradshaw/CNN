#!/bin/bash
# =============================================================================
#  wm_job.sh  —  SLURM batch script for wm_testing.py
#
...
#
#  First submit:   sbatch wm_job.sh
#  Check progress: python wm_testing.py --status
...
python wm_testing.py --timeout 19
