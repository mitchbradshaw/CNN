#!/bin/bash
#SBATCH --job-name=wm_CH7_WIN1min
#SBATCH --chdir=/home/Student/s4699158/CNN
#SBATCH --output=/home/Student/s4699158/CNN/logs/wm_M2_aug_concat_fs1_CH7_WIN1min_STEP100pct_ac879958_%j.out
#SBATCH --error=/home/Student/s4699158/CNN/logs/wm_M2_aug_concat_fs1_CH7_WIN1min_STEP100pct_ac879958_%j.err
...
python Pipelines/run_recipe/run_recipe.py --config HPC/Preprocessing/generated/wm_M2_aug_concat_fs1_CH7_WIN1min_STEP100pct_ac879958.json --force

echo "========================================"
echo "Run finished : $(date)"

python Pipelines/window_matrix_build/wm_status.py --artifact Results/Preprocessing/window_matrix/wm_v1_M2_aug_concat_fs1_CH7_WIN1min_STEP100pct.npz
STATUS=$?
...
if [ "$STATUS" -eq 0 ]; then
    ...
    echo ">>> Resubmit manually if this is expected: sbatch HPC/Preprocessing/generated/wm_M2_aug_concat_fs1_CH7_WIN1min_STEP100pct_ac879958.sh 1"
else
    NEXT=$((CHAIN_INDEX + 1))
    echo ">>> Work remains -- submitting job $NEXT of $MAX_CHAIN ..."
    sbatch HPC/Preprocessing/generated/wm_M2_aug_concat_fs1_CH7_WIN1min_STEP100pct_ac879958.sh "$NEXT"
