"""Start prototype A's bridge against a throwaway copy of the database.

    .venv/Scripts/python.exe run_server.py [--port 8765]

Runs with cwd = the worktree root (recordings.npy_path is repo-relative) and
...
def main():
    ...
    ap.add_argument("--port", type=int, default=int(os.environ.get("PROTO_A_PORT", "8765")))
