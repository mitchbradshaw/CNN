...
from matrix_calc import WindowMatrix, create_matrix_at_timescale, load_matrix
...
from aeon_analysis.transformations import catch22_features, CATCH22_FEATURE_NAMES
...
def compute_cnn_incremental(
    ...
    from cnn.apply_cnn import load_model, window_to_tensor
    from cnn.cnn_rangapur import get_transforms
